...
@ManagedBean
@SessionScoped
public class DetailManagedBean extends TemplatePrimeDataTableManagedBean
	...
	private void setupMaster() {
		...
		if (( this.getUpdatingData().getSelectMasterId() != null ) && ( this.getUpdatingData().getSelectMasterId().compareTo("") != 0 )) {
			this.getUpdatingData().getEntity().setMaster(getMasterService().findByPK(this.getUpdatingData().getSelectMasterId()));
		} else {				
