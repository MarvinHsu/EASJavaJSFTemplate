...
@ManagedBean
@SessionScoped
public class Many1ManagedBean extends TemplatePrimeDataTableManagedBean
	<Many1, java.lang.String, Many1Service>{
	...
	protected void initCreatingData() {
		...
		//When page has many-to-many check box, system will call his.getMany2List() and inject return value to this.updatingData
	...
	/**
	 * manyToMany for Many2 
	 * return Many2 list select item for many-to-many check box
	 * @return List<Many2>
	 */
